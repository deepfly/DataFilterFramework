...
public class WriteWildPointsToFileFilter extends SingleOutputFilter
{
	public void run()
    {
		...
		System.out.println(this.getName() + "::WriteWildPointsToFile Reading ");
		try {
			...
			while (true)
			{
				...
				catch (EndOfStreamException e)
				{
					ClosePorts();
					out.close();
					System.out.println(this.getName() + "::WriteWildPointsToFile Exiting; bytes read: " + bytesread +" bytes written: "+byteswritten);
					break;
				}
			}
		} catch (IOException e) {
